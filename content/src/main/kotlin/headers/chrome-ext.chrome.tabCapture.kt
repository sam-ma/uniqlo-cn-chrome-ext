...
//    var videoConstraints: MediaStreamConstraints? get() = definedExternally; set(value) = definedExternally
    var audioConstraints: Any? get() = definedExternally; set(value) = definedExternally
    var videoConstraints: Any? get() = definedExternally; set(value) = definedExternally
}
...
external fun capture(options: CaptureOptions, callback: (stream: Any?) -> Unit): Unit = definedExternally
