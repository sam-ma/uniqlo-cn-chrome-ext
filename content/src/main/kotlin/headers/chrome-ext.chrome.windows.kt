...
external fun get(windowId: Number, callback: (window: chrome.windows.Window) -> Unit): Unit = definedExternally
external fun get(windowId: Number, getInfo: GetInfo, callback: (window: chrome.windows.Window) -> Unit): Unit = definedExternally
external fun getCurrent(callback: (window: chrome.windows.Window) -> Unit): Unit = definedExternally
external fun getCurrent(getInfo: GetInfo, callback: (window: chrome.windows.Window) -> Unit): Unit = definedExternally
external fun create(callback: ((window: chrome.windows.Window? /*= null*/) -> Unit)? = definedExternally /* null */): Unit = definedExternally
external fun create(createData: CreateData, callback: ((window: chrome.windows.Window? /*= null*/) -> Unit)? = definedExternally /* null */): Unit = definedExternally
external fun getAll(callback: (windows: Array<chrome.windows.Window>) -> Unit): Unit = definedExternally
external fun getAll(getInfo: GetInfo, callback: (windows: Array<chrome.windows.Window>) -> Unit): Unit = definedExternally
external fun update(windowId: Number, updateInfo: UpdateInfo, callback: ((window: chrome.windows.Window) -> Unit)? = definedExternally /* null */): Unit = definedExternally
external fun remove(windowId: Number, callback: Function<*>? = definedExternally /* null */): Unit = definedExternally
external fun getLastFocused(callback: (window: chrome.windows.Window) -> Unit): Unit = definedExternally
external fun getLastFocused(getInfo: GetInfo, callback: (window: chrome.windows.Window) -> Unit): Unit = definedExternally
