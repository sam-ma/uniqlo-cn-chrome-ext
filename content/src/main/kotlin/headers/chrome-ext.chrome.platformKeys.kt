...
external fun getKeyPair(certificate: ArrayBuffer, parameters: Any, callback: (publicKey: Any, privateKey: Any?) -> Unit): Unit = definedExternally
external fun subtleCrypto(): Any = definedExternally
