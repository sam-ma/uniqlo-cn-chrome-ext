...
external interface DocumentScanOptions {
    ...
    var maxImages: Number? get() = definedExternally; set(value) = definedExternally
}
external interface DocumentScanCallbackArg {
    var dataUrls: Array<String>
    var mimeType: String
}
external fun scan(options: DocumentScanOptions, callback: (result: DocumentScanCallbackArg) -> Unit): Unit = definedExternally
