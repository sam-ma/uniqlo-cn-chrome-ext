...
external interface OnRequestEvent : chrome.events.Event<dynamic /* (request: Any, sender: runtime.MessageSender, sendResponse: (response: Any) -> Unit) -> Unit | (sender: runtime.MessageSender, sendResponse: (response: Any) -> Unit) -> Unit */>
