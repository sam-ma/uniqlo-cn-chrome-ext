...
external interface `T$3` {
    var bookmarks_ui: `T$2`? get() = definedExternally; set(value) = definedExternally
}
...
external interface `T$6` {
    var suggested_key: `T$5`? get() = definedExternally; set(value) = definedExternally
...
external interface `T$11` {
    ...
    var actions: Array<`T$10`>? get() = definedExternally; set(value) = definedExternally
...
external interface `T$25` {
    var plugins: `T$24`? get() = definedExternally; set(value) = definedExternally
}
...
external interface Manifest {
    ...
    var background: `T$0`? get() = definedExternally; set(value) = definedExternally
    var background_page: String? get() = definedExternally; set(value) = definedExternally
    var chrome_settings_overrides: `T$1`? get() = definedExternally; set(value) = definedExternally
    var chrome_ui_overrides: `T$3`? get() = definedExternally; set(value) = definedExternally
    var chrome_url_overrides: `T$4`? get() = definedExternally; set(value) = definedExternally
    var commands: `T$7`? get() = definedExternally; set(value) = definedExternally
    var content_capabilities: `T$8`? get() = definedExternally; set(value) = definedExternally
    var content_scripts: Array<`T$9`>? get() = definedExternally; set(value) = definedExternally
    var content_security_policy: String? get() = definedExternally; set(value) = definedExternally
    ...
    var event_rules: Array<`T$11`>? get() = definedExternally; set(value) = definedExternally
    var externally_connectable: `T$12`? get() = definedExternally; set(value) = definedExternally
    var file_browser_handlers: Array<`T$13`>? get() = definedExternally; set(value) = definedExternally
    var file_system_provider_capabilities: `T$14`? get() = definedExternally; set(value) = definedExternally
    var homepage_url: String? get() = definedExternally; set(value) = definedExternally
    var import: Array<`T$15`>? get() = definedExternally; set(value) = definedExternally
    var export: `T$16`? get() = definedExternally; set(value) = definedExternally
    var incognito: String? get() = definedExternally; set(value) = definedExternally
    var input_components: Array<`T$17`>? get() = definedExternally; set(value) = definedExternally
    ...
    var nacl_modules: Array<`T$18`>? get() = definedExternally; set(value) = definedExternally
    var oauth2: `T$19`? get() = definedExternally; set(value) = definedExternally
    var offline_enabled: Boolean? get() = definedExternally; set(value) = definedExternally
    var omnibox: `T$20`? get() = definedExternally; set(value) = definedExternally
    ...
    var options_ui: `T$21`? get() = definedExternally; set(value) = definedExternally
    var permissions: Array<String>? get() = definedExternally; set(value) = definedExternally
    var platforms: Array<`T$22`>? get() = definedExternally; set(value) = definedExternally
    var plugins: Array<`T$23`>? get() = definedExternally; set(value) = definedExternally
    var requirements: `T$25`? get() = definedExternally; set(value) = definedExternally
    var sandbox: `T$26`? get() = definedExternally; set(value) = definedExternally
    ...
    var spellcheck: `T$27`? get() = definedExternally; set(value) = definedExternally
    var storage: `T$28`? get() = definedExternally; set(value) = definedExternally
    var system_indicator: Any? get() = definedExternally; set(value) = definedExternally
    var tts_engine: `T$30`? get() = definedExternally; set(value) = definedExternally
...
external fun getPackageDirectoryEntry(callback: (directoryEntry: Any) -> Unit): Unit = definedExternally
